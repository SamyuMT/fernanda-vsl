...
import { Heart, Users, BookOpen, Award, Instagram, Mail, Phone, CheckCircle, Star, ArrowRight, GraduationCap, Home } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f2e9e2]">
      ...
      <div className="bg-[#1b92d1] text-white text-center py-3 md:py-4">
        <p className="text-xs font-bold uppercase tracking-wide whitespace-nowrap overflow-hidden text-ellipsis">
          TALLER TEÓRICO-PRÁCTICO BASADO EN LA EXPERIENCIA
        </p>
      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mb-6 md:mb-8">
            <div>
              ...
              <div className="flex space-x-3 md:space-x-4">
                <a href="https://instagram.com/licfernandasuarez" className="text-gray-300 hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-1 md:space-y-2 text-gray-300 text-xs md:text-sm">
                <li><a href="#" className="hover:text-white transition-colors">Sobre Fernanda</a></li>
            ...
            <div>
              <h4 className="font-bold mb-3 md:mb-4 text-sm md:text-base">Taller</h4>
              <ul className="space-y-1 md:space-y-2 text-gray-300 text-xs md:text-sm">
